...
class IssueBase(BaseModel):
    ...
    email: Optional[str] = Field(None, max_length=255, description="Reporter contact email (e.g. from external form)")
    phone: Optional[str] = Field(None, max_length=32, description="Reporter contact phone (e.g. from external form)")
...
class IssueCreate(IssueBase):
    ...
    source: IssueSource = Field(
        ...
        description="Defaults to INTERNAL_UI when omitted or null; set EXTERNAL_WEBSITE when the issue is created from your external website",
    )
    # issue_code is auto-generated by system based on type (CMP-#### for COMPLAINT, TKT-#### for SUPPORT)

    @field_validator("source", mode="before")
    @classmethod
    def normalize_issue_source(cls, value: Any) -> Any:
        if value is None or value == "":
            return IssueSource.INTERNAL_UI
        return value
...
class IssueUpdate(BaseModel):
    ...
    @field_validator("email", "phone", mode="before")
    @classmethod
    def empty_str_to_none_update(cls, value: Any) -> Any:
        if value == "":
            return None
        return value
...
class IssueResponse(IssueBase):
    ...
    status: IssueStatus
    issue_status: IssueStatusEnum
    source: IssueSource = IssueSource.INTERNAL_UI
    created_on: datetime
    updated_at: datetime
