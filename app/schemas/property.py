...
class PropertyDetailsBase(BaseModel):
    ...
    nearby_attractions: Optional[List[str]] = Field(None, description="Array of nearby attractions")
    seasonal_experiences: Optional[List[str]] = Field(None, description="Array of seasonal experiences")
    comfort_services_list: Optional[List[str]] = Field(None, description="Array of comfort services")
    noise_level: Optional[bool] = Field(None, description="Whether noise level is acceptable")
